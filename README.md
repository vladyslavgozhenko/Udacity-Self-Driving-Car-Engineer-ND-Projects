...
<img src="readme_images\NeuralNetworkArchitecture.JPG" width="480" alt="LeNet" />  
   ...
   In our case not 10 digits, but 43 traffic signs should be analyzed, thefore we changed number of the outputs to 43.

   Quite offen color information is not critical for neural networks, therefore I will convert images to grayscale.
